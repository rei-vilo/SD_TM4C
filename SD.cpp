...
//
//   */
//  return card.init(csPin, SPI_HALF_SPEED) &&
//         volume.init(card) &&
//         root.openRoot(volume);
//}

bool SDClass::begin(uint8_t chipSelectPin, uint8_t sckRateID, int8_t SPI_Port, int8_t cardDetectionPin, int8_t level)
{
    /*
